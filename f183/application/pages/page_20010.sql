...
,p_group_id=>wwv_flow_imp.id(26835936600398328)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(26837431099398338)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(26837861500398341)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26837114293398337)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26838353853398344)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(26837861500398341)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(26838665732398345)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26839131740398348)
,p_event_id=>wwv_flow_imp.id(26838665732398345)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(26839658754398350)
,p_event_id=>wwv_flow_imp.id(26838665732398345)
